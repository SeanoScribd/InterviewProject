...
import com.sean.oxford.scribdproject.network.AreYouSureCallback
...
abstract class BaseFragmentView<vs : ViewState>(
    ...
    override fun onDetachedFromWindow() {
        ...
        viewModel.stateMessage.removeObservers(context as AppCompatActivity)
        viewModel.returnAction.removeObservers(context as AppCompatActivity)
        viewModel.viewState.removeObservers(context as AppCompatActivity)
        viewModel.dataChannel.numActiveJobs.removeObservers(context as AppCompatActivity)
    }
